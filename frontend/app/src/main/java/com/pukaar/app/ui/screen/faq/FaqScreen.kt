...
enum class FaqEntry(@StringRes val questionRes: Int) {
    HOW_IT_WORKS(R.string.faq_q1),
    HOW_TO_TRIGGER(R.string.faq_q2),
    EMERGENCY_NUMBER(R.string.faq_q3),
    DATA_SAFETY(R.string.faq_q4),
    MORE(R.string.faq_q5)
}
